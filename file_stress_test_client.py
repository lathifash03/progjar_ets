...
class StressTestClient:
    ...
    def run_stress_test(self, operation, file_size_mb, client_pool_size, executor_type='thread'):
        ...
        # Calculate success and fail counts from all_results
        success_count = len([r for r in all_results if r['status'] == 'OK'])
        fail_count = len([r for r in all_results if r['status'] != 'OK'])
        
        # Update the counters
        self.success_count[operation] = success_count
        self.fail_count[operation] = fail_count
